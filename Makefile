...
SOURCES = \
	__init__.py \
	river_metrics.py river_metrics_dockwidget.py

PLUGINNAME = river_metrics

PY_FILES = \
	__init__.py \
	river_metrics.py river_metrics_dockwidget.py

UI_FILES = river_metrics_dockwidget_base.ui
...
QGISDIR=C:\Users\pierl\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
